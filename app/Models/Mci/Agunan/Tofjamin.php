 ...
 * @property string|null $nocif  type: varchar(150)
 ...
 * @property string|null $plafond  type: numeric(5)
 ...
 * @property string|null $an  type: varchar(150)
 ...
 * @property string|null $lokasi  type: varchar(300)
 ...
 * @property string|null $jnsikat  type: varchar(2)
 ...
 */
class Tofjamin extends MciBaseModel
{
    /**
     * Nama tabel (case-sensitive di SQL Server).
     */
    protected $table = 'TOFJAMIN';
