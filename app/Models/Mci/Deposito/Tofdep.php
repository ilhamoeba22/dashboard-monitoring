 ...
 * @property string|null $kdrekprd type: varchar(2)
 ...
 * @property string|null $nmdep type: varchar(100)
 * @property string|null $kdalamat type: varchar(2)
 * @property string|null $kdjoint type: varchar(1)
 * @property string|null $ststrnsbb type: varchar(1)
 ...
 */
class Tofdep extends MciBaseModel
{
    /**
     * Nama tabel (case-sensitive di SQL Server).
     */
    protected $table = 'TOFDEP';

    /**
     * Daftar LENGKAP kolom sesuai database (93 kolom).
