...
/**
 * Model MCI: TOFLMACRUIJR
 * --------------------------------------------------------------------------
 * Domain   : Financing / Loan
 * Tabel    : [dbo].[TOFLMACRUIJR]
 * Kolom    : 24
 ...
 * @property string|null $nosbb03 type: char(7)
 ...
 */
class Toflmacruijr extends MciBaseModel
{
    /**
     * Nama tabel (case-sensitive di SQL Server).
     */
    protected $table = 'TOFLMACRUIJR';
