...
class Toflmb extends MciBaseModel
{
    ...
    {
        return $this->belongsTo(Ao::class, 'kdaoh', 'kdao');
    }
    ...
    {
        return $this->belongsTo(Mcif::class, 'nocif', 'nocif');
    }

    /**
     * RELASI: Tabungan Pokok (Untuk potong angsuran otomatis)
     */
    public function tabunganPokok(): BelongsTo
    {
        return $this->belongsTo(Toftabc::class, 'acpok', 'notab');
    }
    ...
    {
        return $this->hasMany(Tofrs::class, 'nokontrak', 'nokontrak');
    }
    ...
    {
        return $this->belongsTo(Setuploan::class, 'kdprd', 'kdprd');
    }
}
