...
/**
 * Model MCI: M_NERACA03
 * --------------------------------------------------------------------------
 * Domain   : GL / Accounting
 * Tabel    : [dbo].[M_NERACA03]
 * Kolom    : 19
 ...
 * @property string|null $tgl11  type: decimal(9)
 * @property string|null $tgl12  type: decimal(9)
 */
class MNeraca03 extends MciBaseModel
{
    /**
     * Nama tabel (case-sensitive di SQL Server).
     */
    protected $table = 'M_NERACA03';
