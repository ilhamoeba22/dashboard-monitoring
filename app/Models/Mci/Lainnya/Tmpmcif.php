 ...
 * @property string|null $nocifbank type: varchar(9)
 * @property string|null $novabank type: varchar(11)
 */
class Tmpmcif extends MciBaseModel
{
    /**
     * Nama tabel (case-sensitive di SQL Server).
     */
    protected $table = 'TMPMCIF';

    /**
     * Daftar LENGKAP kolom sesuai database (72 kolom).
