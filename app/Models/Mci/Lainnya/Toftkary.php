 ...
 * @property string|null $sts_organ_pelaksana type: varchar(50)
 * @property string|null $kom_manajemen_risk type: varchar(9)
 */
class Toftkary extends MciBaseModel
{
    /**
     * Nama tabel (case-sensitive di SQL Server).
     */
    protected $table = 'TOFTKARY';
