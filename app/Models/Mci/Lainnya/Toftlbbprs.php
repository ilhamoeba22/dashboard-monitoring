...
/**
 * Model MCI: TOFTLBBPRS
 * --------------------------------------------------------------------------
 * Domain   : Lainnya
 * Tabel    : [dbo].[TOFTLBBPRS]
 * Kolom    : 18
 ...
 * @property string|null $kdsandi  type: varchar(3)
 ...
 * @property string|null $ket2  type: varchar(-1)
 * @property string|null $sandilbbprs  type: varchar(10)
 * @property string|null $kdrisk  type: varchar(1)
 */
class Toftlbbprs extends MciBaseModel
{
    /**
     * Nama tabel (case-sensitive di SQL Server).
     */
    protected $table = 'TOFTLBBPRS';
