...
/**
 * Model MCI: TOFTPSNLOKET
 * --------------------------------------------------------------------------
 * Domain   : Pesanan / Payroll
 * Tabel    : [dbo].[TOFTPSNLOKET]
 * Kolom    : 13
 ...
 * @property string $kdloket  type: nvarchar(20)
 ...
 */
class Toftpsnloket extends MciBaseModel
{
    /**
     * Nama tabel (case-sensitive di SQL Server).
     */
    protected $table = 'TOFTPSNLOKET';
