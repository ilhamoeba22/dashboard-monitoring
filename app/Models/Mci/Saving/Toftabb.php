 ...
 * @property string $sawalva  type: numeric(9)
 * @property string $mutasidr  type: numeric(9)
 * @property string $mutasicr  type: numeric(9)
 * @property string|null $sahirrp  type: numeric(9)
 * @property string $sahirva  type: numeric(9)
 * @property string $saldobuku  type: numeric(9)
 * @property string $saldomin  type: numeric(9)
 ...
 * @property string $sahireoy  type: numeric(9)
 * @property string $sahireom  type: numeric(9)
 ...
 * @property string|null $ststabjw  type: char(1)
 * @property string|null $notabdr  type: varchar(11)
 * @property string|null $tgldrawal  type: varchar(8)
 * @property string|null $tgldrnext  type: varchar(8)
 * @property string|null $komitrate  type: numeric(5)
 * @property string|null $komitsaldorata  type: numeric(9)
 * @property string|null $bonus  type: numeric(9)
 * @property string|null $taxbonus  type: numeric(9)
 * @property string|null $stsacmb  type: char(1)
 * @property string|null $byadm2  type: numeric(9)
 * @property string|null $bybh2  type: numeric(9)
 * @property string|null $kdprog  type: char(2)
 * @property string|null $stshdh  type: char(1)
 * @property string|null $rateawal  type: numeric(5)
 * @property string|null $tglnihil  type: varchar(8)
 * @property string|null $grouptab  type: varchar(20)
 */
class Toftabb extends MciBaseModel
{
    /**
     * Nama tabel (case-sensitive di SQL Server).
     */
    protected $table = 'TOFTABB';

    /**
     * Daftar LENGKAP kolom sesuai database (108 kolom).
