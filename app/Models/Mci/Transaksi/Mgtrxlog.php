 ...
 * @property string|null $iddevice  type: varchar(100)
 ...
 * @property string|null $bankid  type: varchar(50)
 * @property string|null $banknama  type: varchar(100)
 * @property string|null $admin  type: numeric(9)
 * @property string|null $total  type: numeric(9)
 * @property string|null $billerreff  type: varchar(25)
 * @property string|null $nmacc  type: varchar(50)
 * @property string|null $nmacclawan  type: varchar(50)
 * @property string|null $rc  type: varchar(5)
 ...
 */
class Mgtrxlog extends MciBaseModel
{
    /**
     * Nama tabel (case-sensitive di SQL Server).
     */
    protected $table = 'MGTRXLOG';
