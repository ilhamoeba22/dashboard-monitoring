...
/**
 * Model MCI: WEBUSERPROFILEHIST
 * --------------------------------------------------------------------------
 * Domain   : User / Auth
 * Tabel    : [dbo].[WEBUSERPROFILEHIST]
 * Kolom    : 16
 ...
 * @property string|null $twofatoken  type: varchar(255)
 ...
 * @property string|null $akses  type: varchar(5)
 */
class Webuserprofilehist extends MciBaseModel
{
    /**
     * Nama tabel (case-sensitive di SQL Server).
     */
    protected $table = 'WEBUSERPROFILEHIST';
