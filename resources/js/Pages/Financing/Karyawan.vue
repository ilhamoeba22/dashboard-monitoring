    ...
    <div class="mb-6">
      <div class="d-flex align-center gap-4 mb-2">
        <div class="header-icon" style="width: 48px; height: 48px; border-radius: 12px; background: rgba(var(--v-theme-primary), 0.1); display: flex; align-items: center; justify-content: center;">
          <v-icon icon="ri-user-star-line" color="primary" size="24" />
        </div>
        <div>
          <h1 class="text-h4 font-weight-bold mb-0" style="font-family: 'Plus Jakarta Sans', sans-serif;">Nominatif Karyawan</h1>
          <p class="text-body-2 text-medium-emphasis mb-0">Daftar rincian nasabah pembiayaan karyawan aktif</p>
        </div>
      </div>
    </div>
