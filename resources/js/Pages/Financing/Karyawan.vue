...
async function loadItems(options) {
  ...
  try {
    ...
    console.error('Gagal memuat data nominatif karyawan:', error)
  } finally {
    loading.value = false
  }
}
...
const exportPDF = async () => {
  ...
  if (logo) {
    ...
    const w = (props.width * h) / props.height // Lebar otomatis
    const x = doc.internal.pageSize.getWidth() - w - 14 // Pojok kanan
      ...
      <div class="fin-hero__inner">
        <div class="fin-hero__top">
          <div class="fin-hero__icon fin-icon-purple">
            <v-icon icon="ri-user-star-line" size="26" color="white" />
          </div>
          <div class="fin-hero__meta">
            <h1 class="fin-hero__title">Nominatif Karyawan</h1>
            <p class="fin-hero__subtitle">Daftar rincian nasabah pembiayaan karyawan berdasarkan periode terpilih</p>
            <div class="fin-hero__badges">
              <span class="fin-badge fin-badge--teal" style="background: rgba(124, 58, 237, 0.2); color: #c4b5fd; border-color: rgba(124, 58, 237, 0.3);">👤 Internal</span>
